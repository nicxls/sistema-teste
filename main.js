            ...
            if (isTransporte) {
                thead.innerHTML = `
                    <tr>
                        ...
                        <th style="padding: 15px; font-size: 11px; color: var(--text-light); text-transform: uppercase; text-align: left; border-bottom: 2px solid var(--border-color); width: 180px;">Nº PROCESSO</th>
